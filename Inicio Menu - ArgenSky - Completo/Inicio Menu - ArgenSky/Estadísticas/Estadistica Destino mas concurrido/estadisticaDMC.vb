...
Public Class estadisticaDMC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.estadisticaDMC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedestadisticaDMC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As estadisticaDMC = New estadisticaDMC()
        rpt.Site = Me.Site
        Return rpt
    End Function
